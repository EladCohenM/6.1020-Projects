    ...
    }, 
    {
        ...
        rules: {
            ...
            // because overriding this option erases the default naming convention rules and replaces them with these rules)
            {
                ...
                format: null, // allows properties like 'node:assert' as long as they're quoted
            }],
            ...
            "jsdoc/require-throws-type": "off", // *should* be required, but the generated docs omit the type
            "jsdoc/tag-lines": "off", // too picky about spacing
            "jsdoc/escape-inline-tags": "off", // allow incorrect inline @module tag
            ...
            "no-magic-numbers": ["error", {
                ignore: [0, 1, 2, -1, -2, '0n', '1n', '2n', '-1n', '-2n'],
            }],
